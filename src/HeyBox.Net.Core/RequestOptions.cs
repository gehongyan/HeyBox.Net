...
{
    /// <inheritdoc cref="HeyBox.RequestOptions()" />
    ...
    /// </summary>
    /// <seealso cref="HeyBox.HeyBoxConfig.DefaultRetryMode"/>
    public RetryMode? RetryMode { get; set; }

    /// <summary>
    ///     获取或设置要写入到房间的审计日志中的操作原因。
    /// </summary>
    /// <remarks>
    ///     默认的 API 客户端不支持设置此属性。
    /// </remarks>
    ...
    /// </summary>
    /// <seealso cref="HeyBox.HeyBoxConfig.DefaultRatelimitCallback"/>
    ...
    /// </summary>
    /// <remarks>
    ///     默认的请求超时时间是 <see cref="HeyBox.HeyBoxConfig.DefaultRequestTimeout"/>。
    /// </remarks>
    public RequestOptions()
    {
        Timeout = HeyBoxConfig.DefaultRequestTimeout;
