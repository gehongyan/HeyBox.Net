...
internal class LogManager
{
    ...
    {
        Level = minSeverity;
        ClientLogger = new Logger(this, "HeyBox");
    }
    ...
    public async Task WriteInitialLog() =>
        await ClientLogger.InfoAsync($"HeyBox.Net v{HeyBoxConfig.Version} (API v{HeyBoxConfig.APIVersion})")
            .ConfigureAwait(false);
}
