...
public sealed class SlashCommandParameterBuilder : ParameterBuilder<SlashCommandParameterInfo, SlashCommandParameterBuilder>
{
    ...
    private readonly List<SlashCommandParameterBuilder> _complexParameterFields = [];
    ...
    /// <param name="complexParameterInitializer">Initializer delegate for this parameter.</param>
    public SlashCommandParameterBuilder(ICommandBuilder command, string name, Type type,
        ComplexParameterInitializer? complexParameterInitializer = null)
    ...
    public SlashCommandParameterBuilder SetParameterType(Type type, IServiceProvider? services)
    {
        ...
        if (!IsComplexParameter)
            TypeConverter = Command.Module.InteractionService.GetTypeConverter(type, services);
    ...
    internal override SlashCommandParameterInfo Build(ICommandInfo command) =>
        new(this, command as SlashCommandInfo ?? throw new InvalidOperationException("Command must be a SlashCommandInfo."));
}
